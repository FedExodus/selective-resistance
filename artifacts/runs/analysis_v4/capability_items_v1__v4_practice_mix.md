...
## lora
- n 200  accuracy **0.710** [95% CI 0.645, 0.770]  (other/unparsed 0)
- by subject: anatomy: 0.68, business_ethics: 0.78, high_school_us_history: 0.93, philosophy: 0.75, professional_law: 0.42
- extraction methods: {'n/a': 200}

## Paired difference (LoRA - base), 200 paired items, cluster bootstrap by problem
- accuracy: +0.015  [95% CI -0.035, +0.065]
